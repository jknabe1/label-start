...
const Page = () => {
  ...
  <section className="grid sm:grid-cols-4 sm:grid-rows-2 w-full h-full p-7 gap-5 grid-cols-1 auto-rows-auto ">
    ...
    <img className="object-cover h-full w-full" alt='' src="https://images.unsplash.com/photo-1685980201821-6577f4feec1a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80"/>
  </section>
  </div>
</div>
  )
